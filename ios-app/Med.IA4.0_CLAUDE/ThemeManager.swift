        ...
        static func getColors(for theme: AppTheme, highContrast: Bool) -> ThemedColors {
            ...
            case .colorBlindFriendly:
                return ThemedColors(
                    ...
                    error: Color(.systemBrown), // Changed from red
                    success: Color(.systemBlue), // Changed from green
                    warning: Color(.systemYellow),
...
extension View {
    ...
    func semanticRole(_ role: AccessibilityRole) -> some View {
        self.accessibilityAddTraits(role.trait)
    }
}
...
extension AccessibilityRole {
    var trait: AccessibilityTraits {
        ...
        case .searchField: return .isSearchField
